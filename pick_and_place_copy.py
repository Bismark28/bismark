...
class MoveItDemo:
    def __init__(self):
        ...
        box1_pose.pose.position.z = (table_ground + table_size[2] + box1_size[2] / 2.0)-0.081
        ...
        box2_pose.pose.position.z = (table_ground + table_size[2] + box2_size[2] / 2.0) -0.081
        ...
        target_pose.pose.position.z = (table_ground + table_size[2] + target_size[2] / 2.0) -0.044
        ...
        place_pose.pose.position.z = (table_ground + table_size[2] + target_size[2] / 2.0) - 0.024
